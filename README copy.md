一个基于vue3搭建的项目。使用Vite做为项目框架，使用TypeScript做为开发语言，项目工具VueRouter、Pinia，项目测试工具Vitest、cypress，代码风格工具F2ELint、ESLint，项目状态监测工具Sentry，其他工具element-plus、axios、crypto-js、dayjs、echarts
